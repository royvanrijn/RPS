...
public class Arena {
    ...
    public void battle() {
        ...
        bots.add(new Bot(QlearningBot.class));
        bots.add(new Bot(RoyBot.class));
        bots.add(new Bot(TimBot.class));
